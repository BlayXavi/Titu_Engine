...
#define TE_MOUSE_BUTTON_LAST      GLFW_MOUSE_BUTTON_8
#define TE_MOUSE_BUTTON_LEFT      GLFW_MOUSE_BUTTON_1
#define TE_MOUSE_BUTTON_RIGHT     GLFW_MOUSE_BUTTON_2
#define TE_MOUSE_BUTTON_MIDDLE    GLFW_MOUSE_BUTTON_3
